...
public class ActivitiesRecyclerAdapter extends RecyclerView.Adapter<ActivitiesRecyclerAdapter.ProfileViewHolder> {
    ...
    private ArrayList<ActivitiesModel> mData;

    public ActivitiesRecyclerAdapter(Context mContext, ArrayList<ActivitiesModel> mData) {
  ...
  /*  public ActivitiesRecyclerAdapter(Context context*//*, ArrayList<ActivitiesModel> data*//*) {
    ...
    public ProfileViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ProfileViewHolder(mInflater.inflate(R.layout.recycler_item_company_stats,parent, false));
    }
